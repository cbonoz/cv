  ...
  work: [
    {
      ...
      badges: ["Hybrid"],
      description:
        "Lead a team in HubSpot's Reporting group, working on the platform powering marketing and sales analytics for 300K+ businesses. Built Kafka pipelines for real-time attribution tracking across the full customer journey. Drove Snowflake optimization cutting P50 query latencies by 50%. Migrated 300K+ legacy reports. Implemented automated purging of attribution objects, reducing storage costs by 40%+.",
    },
    {
      company: "Stavvy",
      location: "Boston, MA",
